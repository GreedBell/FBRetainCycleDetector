Pod::Spec.new do |s|
  s.name         = "FBRetainCycleDetector_Bell"
  s.version      = "0.1.2.1"
  s.summary      = "Library that helps with detecting retain cycles in iOS apps"
  s.homepage     = "https://github.com/GreedBell/FBRetainCycleDetector"
  s.license      = "BSD"
  s.author       = { "Grzegorz Pstrucha" => "gricha@fb.com", "Bell" => "bell@greedlab.com" }
  s.platform     = :ios, "6.0"
  s.source       = {
    :git => "https://github.com/GreedBell/FBRetainCycleDetector.git",
    :tag => "0.1.2.1"
  }
